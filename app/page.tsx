          ...
          {skills.map((skill) => (
            <div key={skill.id} className="group p-8 rounded-2xl bg-[#1e293b] border border-slate-700 hover:border-[#00ff9d]/40 transition-all duration-300 relative overflow-hidden flex flex-col h-full shadow-lg">
              ...
              <div className="flex flex-col gap-3 border-t border-slate-700 pt-6 relative z-10">
                  <a href={skill.demo || skill.url} target="_blank" className="text-center w-full bg-slate-800 border border-slate-600 text-slate-300 px-5 py-3 rounded-lg font-medium text-[12px] hover:bg-slate-700 transition-all">
                    View Demo / SKILL.md
                  </a>
      ...
      <footer className="py-16 bg-[#0f172a] border-t border-slate-800">
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-8 text-[12px] font-medium text-slate-500">
             <Link href="#" className="hover:text-white transition">API Status</Link>
