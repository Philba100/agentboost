...
export default function DesktopWorkstation() {
  ...
  // Global Engine & Hardware Telemetry
  ...
  const [auditLogs, setAuditLogs] = useState<AuditLog[]>([
    { id: '1', timestamp: '15:10:44', system: 'Tender Pipeline', operation: 'TENDER-2026-DXB-551 parsed. Compliance validated.', status: 'COMPLIANT' },
    { id: '2', timestamp: '14:48:12', system: 'AP 3-Way Match', operation: 'PO-88412 matched against GRN. Zero variance.', status: 'VERIFIED' },
    { id: '3', timestamp: '14:20:05', system: 'Trade LC Auditor', operation: 'LC-2026-DXB-9841 checked. Zero demurrage liability.', status: 'VERIFIED' },
    { id: '4', timestamp: '13:58:30', system: 'WPS Payroll SIF', operation: 'Audited monthly SIF batch. Zero ministry infractions.', status: 'COMPLIANT' }
  ]);
  ...
  return (
    <div className="h-full w-full bg-[#0f172a] text-[#f8fafc] font-sans antialiased flex flex-col overflow-hidden select-none selection:bg-[#00ff9d] selection:text-[#0f172a]">
      ...
      {/* 2. Main Workstation Body: Fills 100% of remaining vertical height */}
      <div className="flex-1 flex overflow-hidden min-h-0 w-full">
        {/* Full-Height Pinned Left Sidebar */}
        <DesktopSidebar
        ...
        {/* Dynamic Center Viewport: Expands full height with smooth scrolling */}
